#!/usr/bin/env bash
# 启动 vLLM generator (Qwen3-8B) —— 2x A800 80GB, tensor-parallel=2
# 适配 HPC 二期（mgmt-4）
#
# 用法:
#   bash scripts/launch_vllm_gen_2xa800.sh               # 前台
#   nohup bash scripts/launch_vllm_gen_2xa800.sh &       # 后台
#   CUDA_VISIBLE_DEVICES=0,1 bash scripts/launch_vllm_gen_2xa800.sh
...
LOG_FILE="$LOG_DIR/vllm_2xa800_${TS}.log"
PID_FILE="$LOG_DIR/vllm_2xa800.pid"
